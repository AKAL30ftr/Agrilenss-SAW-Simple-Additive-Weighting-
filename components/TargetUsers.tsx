    ...
    >
      <div className="px-6 py-5 flex justify-between items-center bg-white/5">
        <div className="flex items-center gap-4">
          ...
          <h3 className="text-white font-bold text-lg font-heading">Target Users</h3>
        </div>
      ...
      <div className="px-6 py-6 border-t border-white/10 bg-black/20">
        ...
        >
          <motion.li variants={item} className="flex items-center gap-3">
            ...
            <span>Commercial Farm Managers seeking yield maximization.</span>
          </motion.li>
          <motion.li variants={item} className="flex items-center gap-3">
            <span className="w-2 h-2 shrink-0 bg-emerald-400 rounded-full shadow-[0_0_8px_rgba(74,222,128,0.8)]" />
            <span>Governmental Agricultural Policy Makers.</span>
          </motion.li>
          <motion.li variants={item} className="flex items-center gap-3">
            <span className="w-2 h-2 shrink-0 bg-emerald-400 rounded-full shadow-[0_0_8px_rgba(74,222,128,0.8)]" />
            <span>Agronomists specializing in soil-crop compatibility.</span>
          </motion.li>
        </motion.ul>
      </div>
    </motion.div>
